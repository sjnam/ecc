...
func (ec *Curve) Params() *elliptic.CurveParams {
...
func (ec *Curve) polynomial(x *big.Int) *big.Int {
...
func (ec *Curve) IsOnCurve(x, y *big.Int) bool {
	// y² = x³ + ax + b
...
// top of the file.
func (ec *Curve) affineFromJacobian(x, y, z *big.Int) (
	xOut, yOut *big.Int,
) {
	if z.Sign() == 0 {
...
func (ec *Curve) addJacobian(x1, y1, z1, x2, y2, z2 *big.Int) (
...
func (ec *Curve) Double(x1, y1 *big.Int) (*big.Int, *big.Int) {
	z1 := zForAffine(x1, y1)
...
func (ec *Curve) doubleJacobian(x, y, z *big.Int) (
	*big.Int, *big.Int, *big.Int) {
...
func (ec *Curve) ScalarMult(Bx, By *big.Int, k []byte) (
	*big.Int, *big.Int,
) {
